...
const helperlistingdetail = () => {
  return (
    <>
      <section className="flex flex-col gap-4 dark:h-screen">
        <MetaTitle title={"Helper MF View | Anarock"} />
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
          <Heading sectionLink="/helperlisting" parent="Helper listing view" mainTitle="Helper Listing View" />
        </div>
...
export default helperlistingdetail
