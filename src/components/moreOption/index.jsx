    ...
    <div className="relative">
      ...
      {open && (
        <div
          ref={menuRef}
          id="dropdownHover"
          class="absolute top-6 right-16 overflow-hidden bg-white divide-y divide-gray-100 dark:divide-gray-700 border rounded-md shadow z-50 !border-gray-100 dark:border-gray-700"
        >
